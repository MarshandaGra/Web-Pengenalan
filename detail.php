...
<div class="container-xl">
	<div class="table-responsive">
		<div class="table-wrapper">
			...
			<?php
			include 'koneksi.php';
			$query = 'SELECT * FROM detail_pelanggaran';
			...
			while ($result = mysqli_fetch_assoc($mysqliquery)) {
				...
				<tr>
					...
					<td>
						<a href="edit5.php?id=<?php echo $result['id']; ?>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Update">&#xE254;</i></a>
						<a href="delete5.php?ids=<?php echo $result['id']; ?>" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
					</td>
				</tr>
				<?php
			}
		...
		<div class="modal-content">
			<form method="POST" action="insert5.php" >
				<div class="modal-header">						
					<h4 class="modal-title">Tambahkan Detail Pelanggaran</h4>
