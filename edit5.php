...
if (isset($_POST['ubah'])) {
    ...
    // update user data
    $ambil= "UPDATE detail_pelanggaran SET nama_pelanggaran='$nama_pelanggaran',poin='$poin' WHERE id=$id";
...
$ambil= mysqli_query($db, "SELECT * FROM detail_pelanggaran WHERE id=$id");
    ...
    <section class="container-fluid mb-4">
        ...
        <section class="row justify-content-center">
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="edit5.php" method="POST">
                    <h4> UPDATE DETAIL PELANGGARAN</h4>
                    <?php if ($error != '') { ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama_pelanggaran" name="nama_pelanggaran" placeholder="Masukkan Nama Pelanggaran" value="<?php echo $nama_pelanggaran; ?>">
                    </div>
                    <div class="form-group">
                        <label for="poin">Poin</label>
                        <input type="text" class="form-control" id="poin" name="poin" placeholder="Masukkan Poin" value="<?php echo $poin; ?>">
                    </div>
                    <div>
