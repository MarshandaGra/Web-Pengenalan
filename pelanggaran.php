	...
	<div class="table-responsive">
		<div class="table-wrapper">
			...
			<table class="table table-striped table-hover">
                ...
                <?php
			include 'koneksi.php';
			$query = 'SELECT pelanggaran.id,pelanggaran.nama, pelanggaran.kelas_id, pelanggaran.detail_pelanggaran_id, kelas.nama_kelas, kelas.wali_kelas, 
			detail_pelanggaran.nama_pelanggaran, detail_pelanggaran.poin FROM pelanggaran JOIN kelas ON pelanggaran.kelas_id = kelas.id 
			JOIN detail_pelanggaran ON pelanggaran.detail_pelanggaran_id = detail_pelanggaran.id ORDER BY poin DESC;';
			...
			while ($result = mysqli_fetch_assoc($mysqliquery)) {
				...
				<tr>
					...
					<td>
						<?php echo $result['nama_pelanggaran']; ?>
					</td>
					<td>
						<?php echo $result['poin']; ?>
					</td>
					<td>
						<?php echo $result['wali_kelas']; ?>
					</td>
					<td>
						<a href="edit2.php?id=<?php echo $result['id']; ?>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Update">&#xE254;</i></a>
						<a href="delete2.php?ids=<?php echo $result['id']; ?>" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
					</td>
				</tr>
				<?php
			}
		...
		<div class="modal-content">
			<form method="POST" action="insert2.php" >
				<div class="modal-header">						
					<h4 class="modal-title">Tambahkan Data Pelanggaran</h4>
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						...
						<!-- <input type="text"  class="form-control" name="jenis_pel" required> -->
						<select id="detail_pelanggaran_id" name="detail_pelanggaran_id">
						<option>Pilih Jenis Pelanggaran</option>
							<?php 
							$data2 = mysqli_query($db,"select * from detail_pelanggaran");
							while($d2 = mysqli_fetch_array($data2)){
								?>
								<option value="<?php echo $d2['id'] ?>"><?php echo $d2['nama_pelanggaran'] ?></option>
								<?php
							}
							?>				
						</select>
