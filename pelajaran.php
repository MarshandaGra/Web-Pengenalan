	...
	<div class="table-responsive">
		<div class="table-wrapper">
			...
			<table class="table table-striped table-hover">
				...
				<?php
			include 'koneksi.php';
			$query = 'SELECT pelajaran.id, pelajaran.mapel, pelajaran.guru_pengajar, pelajaran.kelas_id, kelas.wali_kelas, 
			kelas.nama_kelas FROM pelajaran JOIN kelas ON pelajaran.kelas_id = kelas.id;';
			$mysqliquery = mysqli_query($db, $query);
			while ($result = mysqli_fetch_assoc($mysqliquery)) {
				?>
				<tr>
					<td><?php echo $result['mapel']; ?></td>
					<td><?php echo $result['guru_pengajar']; ?></td>
					<td><?php echo $result['nama_kelas']; ?></td>
					<td><?php echo $result['wali_kelas']; ?></td>
					<td>
						<a href="edit4.php?id=<?php echo $result['id']; ?>" class="edit">
							<i class="material-icons" data-toggle="tooltip" title="Update">&#xE254;</i></a>
						<a href="delete4.php?id=<?php echo $result['id']; ?>" class="delete">
		...
		<div class="modal-content">
			<form method="POST" action="insert4.php" >
				<div class="modal-header">						
					<h4 class="modal-title">Tambahkan Data Pelajaran</h4>
